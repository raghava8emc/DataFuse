...
const MongoDBConfig = ({ formData, setFormData }) => {
    ...
    const [localConfig, setLocalConfig] = useState({
        ...
        collection_names: formData.collection_names || "", // Ensure consistent naming with backend
    });
    ...
    return (
        <div className="db-config-container">
            ...
            <div className="db-input-group">
                <label>🗂️ Collection Names (Comma-Separated):</label>
                <input type="text" name="collection_names" value={localConfig.collection_names} onChange={handleChange} />
            </div>
        </div>
    );
};
